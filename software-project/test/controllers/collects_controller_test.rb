...
class CollectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collect" do
    assert_difference("Collect.count") do
      post collects_url, params: { collect: { manipulator_id: @collect.manipulator_id, song_id: @collect.song_id } }
    end
  ...
  test "should update collect" do
    patch collect_url(@collect), params: { collect: { manipulator_id: @collect.manipulator_id, song_id: @collect.song_id } }
