...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference("Picture.count") do
      post pictures_url, params: { picture: { manipulator_id: @picture.manipulator_id, 图片: @picture.图片 } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { manipulator_id: @picture.manipulator_id, 图片: @picture.图片 } }
